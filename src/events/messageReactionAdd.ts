 ...
 */
const messageReactionAdd: event<'messageReactionAdd'> = async (client: Client<true>, r: MessageReaction | PartialMessageReaction, u: User | PartialUser): Promise<undefined | boolean> =>
{
